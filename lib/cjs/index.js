...
const FileUploader = _ref => {
  ...
  */
  ...
  React.useState(null);
  const [fileInBase64, setFileInBase64] = React.useState(null);
...
const Pagination = _ref => {
  ...
  const [lastItemIndex, setLastItemIndex] = React.useState(itemsPerPage);
...
const Tooltip = _ref => {
  ...
  const [tooltipWidth, setTooltipWidth] = React.useState(null);
  const [tooltipHeight, setTooltipHeight] = React.useState(null);
  const tooltipRef = React.useRef(null);
  const tooltipParentRef = React.useRef(null);
