...
const Accordion = _ref => {
  ...
  const [activeAccordion, setActiveAccordion] = React$1.useState("0");
  return (
    /*#__PURE__*/
    ...
    2.
    */
    React$1.createElement("div", null, accordionList.map(item => /*#__PURE__*/React$1.createElement(AccordionItem, {
      key: item.id,
      item: item,
...
const AccordionItem = _ref2 => {
  ...
  }, /*#__PURE__*/React$1.createElement("p", null, item.question), /*#__PURE__*/React$1.createElement("div", {
  ...
  }))), item.id === activeAccordion && /*#__PURE__*/React$1.createElement("p", {
...
const FileUploader = _ref => {
  ...
  */
  ...
  const [sizeLimit, setSizeLimit] = React$1.useState({});
  const [selectedFileName, setSelectedFileName] = React$1.useState(null);
  React$1.useState(null);
  const [fileInBase64, setFileInBase64] = React$1.useState(null);
  const [errorMessage, setErrorMessage] = React$1.useState("");
  const [canHighlight, setCanHighlight] = React$1.useState(false);
...
const Link = _ref => {
  ...
  }, children, isPairedWithIcon && /*#__PURE__*/React$1.createElement("i", {
    className: icon
  }));
};
...
const Pagination = _ref => {
  ...
  const [groupedData, setGroupedData] = React$1.useState([]);
  // console.log("groupedData:", groupedData);

  // const [itemsPerPage, setItemsPerPage] = useState(5);
  const [currentPage, setCurrentPage] = React$1.useState(1);
  const [firstItemIndex, setFirstItemIndex] = React$1.useState(0);
  const [lastItemIndex, setLastItemIndex] = React$1.useState(itemsPerPage);
  ...
  return /*#__PURE__*/React$1.createElement("div", null, groupedData.length > 0 && groupedData[currentPage - 1]?.map((d, i) => /*#__PURE__*/React$1.createElement(Todo, {
    key: i,
    todo: d
  })), /*#__PURE__*/React$1.createElement("div", {
  ...
  }, /*#__PURE__*/React$1.createElement("p", null, "Items per page:"), /*#__PURE__*/React$1.createElement("select", {
    value: itemsPerPage,
    onChange: e => {
    ...
    value: 5
  }, "5"), /*#__PURE__*/React$1.createElement("option", {
    value: 10
  }, "10"), /*#__PURE__*/React$1.createElement("option", {
    value: 15
  }, "15"), /*#__PURE__*/React$1.createElement("option", {
    value: 20
  }, "20"), /*#__PURE__*/React$1.createElement("option", {
    value: 25
  }, "25"))), /*#__PURE__*/React$1.createElement("p", {
    className: "border-r-[1px] border-gray-300 flex-1 p-2"
  }, firstItemIndex + 1, " - ", lastItemIndex, " of ", data.length, " items"), /*#__PURE__*/React$1.createElement("div", {
    className: "flex items-center border-r-[1px] border-gray-300 p-2"
  }, /*#__PURE__*/React$1.createElement("select", {
    value: currentPage,
    onChange: e => setCurrentPage(Number(e.target.value))
  }, pageNumbers.map((pageNo, i) => /*#__PURE__*/React$1.createElement("option", {
    key: i,
    value: pageNo
  }, pageNo))), /*#__PURE__*/React$1.createElement("p", null, "of ", pageNumbers.length, " pages")), /*#__PURE__*/React$1.createElement("div", {
...
const Todo = _ref2 => {
  ...
  return /*#__PURE__*/React$1.createElement("p", null, todo.title);
};

const StarRating = () => {
  // on clicking any star, set a stateful Rating value to be the rating value of clicked star
  const [selectedRating, setSelectedRating] = React$1.useState(null);
  const [hoveredRating, setHoveredRating] = React$1.useState(null);
  //   apply yellow color to stars whose value falls within the selectedRating value

  return /*#__PURE__*/React$1.createElement("div", null, [...Array(5)].map((value, i) => {
    const rating = i + 1;
    return /*#__PURE__*/React$1.createElement("label", null, /*#__PURE__*/React$1.createElement("button", {
...
const Tab = _ref => {
  ...
  const [activeTab, setActiveTab] = React$1.useState("tab1");
  ...
  }, tabNavList.map(nav => /*#__PURE__*/React$1.createElement("li", {
  ...
  }, nav.title))), /*#__PURE__*/React$1.createElement("main", {
    className: "py-10 px-5"
  }, tabContentData.map(content => {
    if (content.id === activeTab) {
      return /*#__PURE__*/React$1.createElement(TabContent, {
        key: content.id,
        animation: tabAnimation
      }, /*#__PURE__*/React$1.createElement("h1", null, "Yoo, this is epic!"), /*#__PURE__*/React$1.createElement("p", null, content.contents));
    }
  })));
};
...
const TextInput = _ref => {
  ...
  return /*#__PURE__*/React$1.createElement("form", null, showLabelText && /*#__PURE__*/React$1.createElement("label", {
    className: "text-sm text-gray-500"
  }, labelText), /*#__PURE__*/React$1.createElement("div", {
  ...
  }, rest)), isPasswordMode && /*#__PURE__*/React$1.createElement("button", {
    type: "button",
    onClick: togglePasswordVisibility
  }, /*#__PURE__*/React$1.createElement("i", {
    className: `fa-solid fa-${showPassword ? "eye" : "eye-slash"}`
  }))), showHelperText && /*#__PURE__*/React$1.createElement("span", {
    className: "text-sm"
  }, helperText));
};
...
const ToggleSwitch = _ref => {
  ...
  const [isToggled, setIsToggled] = React$1.useState(false);
  ...
  }, showLabel && /*#__PURE__*/React$1.createElement("i", {
...
const Tooltip = _ref => {
  ...
  const [tooltipWidth, setTooltipWidth] = React$1.useState(null);
  const [tooltipHeight, setTooltipHeight] = React$1.useState(null);
  const tooltipRef = React$1.useRef(null);
  const tooltipParentRef = React$1.useRef(null);
